export declare const ESCROW_STATES: readonly ["CREATED", "TAKEN", "FUNDED", "PAYMENT_CONFIRMED", "DISPUTED", "RESOLVED", "CANCELLED"];
export type EscrowState = (typeof ESCROW_STATES)[number];
export declare const DISPUTE_OUTCOMES: readonly ["BUYER_WINS", "SELLER_WINS", "NONE"];
