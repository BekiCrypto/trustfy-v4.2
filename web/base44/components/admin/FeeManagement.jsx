    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <Alert className="bg-purple-500/10 border-purple-500/30">
        ...
        <AlertDescription className="text-purple-300 text-sm">
          <strong>V3 Fee Management:</strong> Platform fees are collected in pooled smart contract storage. 
          Use the Platform Withdrawal section below to withdraw fees and bond revenue separately on-chain.
        </AlertDescription>
      </Alert>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border-blue-500/30 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs">completed trades</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/30 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-slate-400 text-sm">Dispute Fees</p>
      ...
      <Card className="bg-slate-900/50 border-slate-700/50 p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Available Fees by Token</h3>
      ...
      {/* Database Fee Tracking (Legacy - For Reference) */}
      <Card className="bg-slate-900/50 border-amber-500/30 p-6">
        <Alert className="bg-amber-500/10 border-amber-500/30 mb-4">
          ...
          <AlertDescription className="text-amber-300 text-xs">
            <strong>Note:</strong> This shows estimated fees from completed trades in the database. 
            For actual on-chain fee withdrawals, use the <strong>Platform Withdrawal</strong> section below.
          </AlertDescription>
        </Alert>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Database Fee Tracker</h3>
            <p className="text-slate-400 text-sm">Estimated fees from completed trades (reference only)</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label className="text-slate-300">Estimated Available</Label>
          ...
          <Alert className="bg-blue-500/10 border-blue-500/30">
            ...
            <AlertDescription className="text-blue-300 text-xs">
              Use <strong>Platform Withdrawal</strong> below to withdraw actual on-chain fees and bond revenue from the smart contract.
            </AlertDescription>
          </Alert>
        </div>
      </Card>
            ...
            return (
              <div key={trade.id} className="flex items-center justify-between p-3 rounded-lg bg-slate-800/30 hover:bg-slate-800/50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white text-sm font-medium">Trade #{trade.trade_id?.slice(-8)}</p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-slate-500 text-xs">Maker: {trade.maker_fee}% | Taker: {trade.taker_fee}%</p>
                </div>
              </div>
            );
          })}
