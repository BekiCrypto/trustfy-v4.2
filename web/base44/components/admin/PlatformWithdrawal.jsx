...
export default function PlatformWithdrawal({ chain = 'BSC', tokens = ['USDT', 'USDC', 'BNB'] }) {
  ...
  const handleWithdraw = async (token) => {
    ...
    if (parseFloat(feeAmount) > availableFees) {
      toast.error('Fee amount exceeds available pool');
      return;
    }
    ...
    try {
      ...
      toast.success('Platform proceeds withdrawn!', {
        description: `${feeAmount} fees + ${bondAmount} bond revenue transferred`,
        action: {
          label: 'View TX',
    ...
    <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700/50 p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs">V3 separate fee & bond pools</p>
          </div>
        </div>
        <Button
          variant="outline"
      ...
      <Alert className="bg-blue-500/10 border-blue-500/30 mb-6">
        ...
        <AlertDescription className="text-blue-300 text-xs">
          <strong>V3 Revenue Tracking:</strong> Platform fees and bond revenue (from lost disputes) are tracked separately. 
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="p-4 rounded-lg bg-gradient-to-r from-emerald-500/20 to-green-500/20 border border-emerald-500/30">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-slate-400 text-xs">Total Fee Pool</span>
          </div>
            ...
            >
              ...
              {hasRevenue && (
                <div className="space-y-3 pt-3 border-t border-slate-700">
                  ...
                  {feePool > 0 && (
                    <div>
                      <label className="text-xs text-slate-400 mb-1 block">Withdraw from Fee Pool</label>
