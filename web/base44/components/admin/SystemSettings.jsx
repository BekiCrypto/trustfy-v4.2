    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <Card className="bg-slate-900/50 border-slate-700/50 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">Configure platform trading fees</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label className="text-slate-300">Default Maker Fee (%)</Label>
              <Input
                type="number"
                step="0.1"
            ...
            <div>
              <Label className="text-slate-300">Default Taker Fee (%)</Label>
              <Input
                type="number"
                step="0.1"
          ...
          <div>
            <Label className="text-slate-300">Dispute Fee (%)</Label>
            <Input
              type="number"
              step="0.1"
      ...
      <Card className="bg-slate-900/50 border-slate-700/50 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Trade Configuration</h3>
            <p className="text-slate-400 text-sm">Configure trade limits and timeouts</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label className="text-slate-300">Min Trade Amount ($)</Label>
              <Input
                type="number"
            ...
            <div>
              <Label className="text-slate-300">Max Trade Amount ($)</Label>
              <Input
                type="number"
          ...
          <div>
            <Label className="text-slate-300">Default Trade Timeout (hours)</Label>
            <Input
              type="number"
