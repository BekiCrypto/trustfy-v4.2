      ...
      <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-slate-700/50 backdrop-blur-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Policy adoption and performance</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/30">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs text-purple-400">Total Policies</p>
            </div>
            <p className="text-2xl font-bold text-white">{metrics.totalPolicies}</p>
            <p className="text-xs text-slate-500 mt-1">{metrics.activePolicies} active</p>
          </div>
          
          <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
            <div className="flex items-center gap-2 mb-2">
              <TrendingUp className="w-4 h-4 text-emerald-400" />
              <p className="text-xs text-emerald-400">Adoption Rate</p>
            </div>
            <p className="text-2xl font-bold text-white">{metrics.adoptionRate}%</p>
            <p className="text-xs text-slate-500 mt-1">of all trades</p>
          </div>
          
          <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
            <div className="flex items-center gap-2 mb-2">
              <DollarSign className="w-4 h-4 text-blue-400" />
              <p className="text-xs text-blue-400">Total Premiums</p>
            </div>
          ...
          <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs text-amber-400">Claim Rate</p>
            </div>
            <p className="text-2xl font-bold text-white">{metrics.claimRate}%</p>
            <p className="text-xs text-slate-500 mt-1">{metrics.claimedPolicies} claims</p>
          </div>
        </div>
        
        {/* Policies vs Claims Chart */}
        <div className="mt-6">
          <p className="text-sm font-medium text-slate-400 mb-4">30-Day Trend</p>
