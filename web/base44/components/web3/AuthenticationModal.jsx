              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-slate-400 text-sm">
                    Choose from 200+ supported wallets
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-center gap-3 flex-wrap">
                    {['MetaMask', 'Trust Wallet', 'Coinbase', 'WalletConnect'].map(wallet => (
                      <div key={wallet} className="px-3 py-1 rounded-full bg-slate-800 text-slate-400 text-xs">
                        {wallet}
                      </div>
                    ))}
                  </div>
              ...
              >
                ...
                <Alert className="bg-blue-500/10 border-blue-500/30">
                  ...
                  <AlertDescription className="text-blue-300 text-xs">
                    <strong>Free signature</strong> - No transaction, no gas fees required
                  </AlertDescription>
                </Alert>
