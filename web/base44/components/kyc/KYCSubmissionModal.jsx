...
Provide detailed verification with clear recommendation.`,
    ...
    onSuccess: (result) => {
      ...
      if (result.status === 'verified') {
        toast.success('KYC verified automatically! You can now trade without limits.');
      } else if (result.status === 'rejected') {
        toast.error('KYC documents were rejected. Please check and resubmit.');
      } else {
        toast.success('KYC submitted! We\'ll review your documents and notify you soon.');
      }
