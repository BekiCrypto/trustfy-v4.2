...
const statusConfig = {
  ...
  funded: { 
    ...
    text: 'text-blue-400', 
    label: 'Funded',
    detail: 'Seller bond locked • Awaiting buyer'
  },
  in_progress: { 
