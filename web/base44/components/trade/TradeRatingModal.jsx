  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-slate-900 border-slate-800 max-w-md">
        <DialogHeader>
          <DialogTitle className="text-white text-xl">Rate Your Trading Partner</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          {/* Quick Tags */}
          <div>
            <p className="text-slate-400 text-sm mb-3">Quick feedback (optional)</p>
          ...
          {/* Review Text */}
          <div>
            <p className="text-slate-400 text-sm mb-2">Add a comment (optional)</p>
            <Textarea
              value={reviewText}
