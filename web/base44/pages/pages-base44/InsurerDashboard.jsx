...
export default function InsurerDashboard() {
  ...
  // Mock chart data
  const premiumData = [
    { month: 'Jan', premiums: 1200, claims: 400 },
    { month: 'Feb', premiums: 1500, claims: 600 },
    { month: 'Mar', premiums: 1800, claims: 500 },
    { month: 'Apr', premiums: 2100, claims: 800 },
    { month: 'May', premiums: 2400, claims: 700 },
    { month: 'Jun', premiums: 2800, claims: 900 }
  ];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8">
        <div className="max-w-2xl mx-auto text-center py-20">
          ...
          <p className="text-slate-400 mb-6">You need to register as an insurance provider first.</p>
      ...
      <div className="relative max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatsCard
            ...
            subtitle={`$${provider.capital_staked?.toLocaleString()} staked`}
          />
          <StatsCard
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-slate-700/50 backdrop-blur-xl p-6">
            <h3 className="text-lg font-semibold text-white mb-4">Premiums vs Claims</h3>
            <div className="h-64">
        ...
        <Tabs defaultValue="policies" className="w-full">
          ...
          <TabsContent value="policies" className="mt-6">
            {policiesLoading ? (
              ...
              <div className="text-center py-20 bg-slate-800/30 rounded-xl border border-slate-700/50">
                ...
                <h3 className="text-lg font-semibold text-slate-300 mb-2">No policies yet</h3>
                <p className="text-slate-500">Policies will appear here once trades are insured</p>
              </div>
            ) : (
          ...
          <TabsContent value="claims" className="mt-6">
            {claimsLoading ? (
              ...
              <div className="text-center py-20 bg-slate-800/30 rounded-xl border border-slate-700/50">
                ...
                <h3 className="text-lg font-semibold text-slate-300 mb-2">No claims yet</h3>
                <p className="text-slate-500">Claims will appear here when filed by insured parties</p>
              </div>
            ) : (
          ...
          <TabsContent value="settings" className="mt-6">
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-slate-700/50 backdrop-blur-xl p-6">
              <h3 className="text-lg font-semibold text-white mb-6">Provider Settings</h3>
              
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-sm text-slate-400 mb-2 block">Base Premium Rate</label>
                  ...
                  <div>
                    <label className="text-sm text-slate-400 mb-2 block">Provider Rating</label>
                    <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                  ...
                  <div>
                    <label className="text-sm text-slate-400 mb-2 block">Min Coverage</label>
                    <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                  ...
                  <div>
                    <label className="text-sm text-slate-400 mb-2 block">Max Coverage</label>
                    <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                ...
                <div>
                  <label className="text-sm text-slate-400 mb-2 block">Auto-Approve Policies</label>
                  <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                    <p className="text-white">{provider.auto_approve ? '✅ Enabled' : '❌ Disabled'}</p>
                  </div>
                </div>
