      ...
      <div className="relative max-w-7xl mx-auto space-y-8">
            ...
            <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-xl p-4">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex gap-6 text-sm">
                  ...
                  <div>
                    <p className="text-slate-400">{t('dashboard.feeDiscount')}</p>
                    <p className="text-lg font-semibold text-blue-400">{profile.maker_fee_discount}%</p>
                  </div>
                  <div>
        ...
        >
          <StatsCard
            ...
            trend="up"
            trendValue={`${trades.length} ${t('dashboard.trades')}`}
            prefix=""
            suffix=" tokens"
          />
          <StatsCard
            ...
            subtitle={`${trades.length} ${t('dashboard.totalTrades')}`}
          />
          <StatsCard
          ...
          <StatsCard
            ...
            subtitle={activeDisputes === 0 ? t('dashboard.allResolved') : t('dashboard.needsAttention')}
          />
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {tradesLoading ? (
                <LoadingSpinner text="Loading your trades..." />
              ) : trades.length === 0 && !tradesError ? (
                <EmptyState
                  icon={Wallet}
                  title={t('dashboard.noTradesYet')}
                  description={t('dashboard.startTrading')}
                >
