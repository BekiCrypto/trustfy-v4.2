      ...
      <div className="relative max-w-7xl mx-auto space-y-6">
        ...
        <Alert className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 border-purple-500/30">
          ...
          <AlertDescription className="text-purple-300 text-sm">
            <strong>Smart Escrow:</strong> Secure trading with reusable bond credits.
          </AlertDescription>
        </Alert>
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            actionLabel={t('marketplace.createOffer')}
          />
        ) : !error && (
        ...
        {!isLoading && filteredOffers.length > 0 && (
          <div className="text-center text-sm text-slate-500 pt-4">
            Showing {filteredOffers.length} of {offers.length} ads
          </div>
        )}
      </div>
