      ...
      <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 border-slate-700/50 backdrop-blur-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-white flex items-center gap-2">
              ...
              {t('analytics.disputeMetrics')}
            </h3>
            <p className="text-sm text-slate-400 mt-1">{t('arbitrator.resolutionRate')}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700/50">
            <p className="text-xs text-slate-400 mb-1">{t('arbitrator.totalDisputes')}</p>
            <p className="text-2xl font-bold text-white">{metrics.total}</p>
            <p className="text-xs text-slate-500 mt-1">{metrics.disputeRate}%</p>
          </div>
          
          <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700/50">
            <p className="text-xs text-slate-400 mb-1">{t('disputes.resolved')}</p>
            <p className="text-2xl font-bold text-emerald-400">{metrics.resolved}</p>
            <p className="text-xs text-slate-500 mt-1">{metrics.resolutionRate}%</p>
          </div>
          
          <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700/50">
            <p className="text-xs text-slate-400 mb-1">{t('arbitrator.pending')}</p>
            <p className="text-2xl font-bold text-amber-400">{metrics.pending}</p>
          </div>
          
          <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700/50">
            <p className="text-xs text-slate-400 mb-1">{t('arbitrator.escalationLevel')}</p>
        ...
        {/* Resolution by Tier */}
        <div className="mb-6">
          <p className="text-sm font-medium text-slate-400 mb-3">{t('arbitrator.escalationLevel')}</p>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-3 rounded-lg bg-violet-500/10 border border-violet-500/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white">{t('arbitrator.tier1Automated')}</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white">{t('arbitrator.tier2HumanReview')}</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-purple-500/10 border border-purple-500/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white">{t('arbitrator.tier3DAOVote')}</span>
              </div>
        ...
        {/* Ruling Outcomes */}
        <div>
          <p className="text-sm font-medium text-slate-400 mb-3">{t('arbitrator.rulingDistribution')}</p>
          <div className="flex gap-2">
            <div className="flex-1 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-center">
              <p className="text-xs text-emerald-400 mb-1">{t('arbitrator.favorSeller')}</p>
            ...
            <div className="flex-1 p-3 rounded-lg bg-blue-500/10 border border-blue-500/30 text-center">
              <p className="text-xs text-blue-400 mb-1">{t('arbitrator.favorBuyer')}</p>
            ...
            <div className="flex-1 p-3 rounded-lg bg-purple-500/10 border border-purple-500/30 text-center">
              <p className="text-xs text-purple-400 mb-1">{t('arbitrator.split')}</p>
