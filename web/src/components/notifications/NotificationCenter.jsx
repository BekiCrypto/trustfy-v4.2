            ...
            <div className="flex items-center gap-2">
              ...
              {notification.priority !== 'medium' && (
                <Badge className={`text-xs ${priority.badge} ${priority.color} border-0`}>
                  {t(`notificationsPanel.priority.${notification.priority}`)}
                </Badge>
              )}
              {notification.link && (
            ...
            <AnimatePresence mode="popLayout">
              {isLoading ? (
                ...
                <div className="text-center py-10">
                  ...
                  <p className="text-slate-400">{t('notificationsPanel.emptyTitle')}</p>
                  <p className="text-slate-500 text-sm mt-1">
                    {filter === 'unread'
                      ? t('notificationsPanel.emptyUnread')
                      : t('notificationsPanel.emptyAll')}
                  </p>
                </div>
              ) : (
