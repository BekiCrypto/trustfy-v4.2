...
const ACTION_HELP: Record<string, string> = {
  ...
  fund: "Seller locks funds and bond on-chain.",
  ...
  withdraw: "Admin withdraws platform revenue.",
}
  ...
  return (
    <div className="space-y-3">
      {actions.map((action) => {
        ...
        return (
          <div key={action.id} className="rounded-2xl border border-[color:var(--line)] bg-slate-900/60 p-4">
            <button
              type="button"
              className={style}
