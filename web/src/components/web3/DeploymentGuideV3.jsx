          ...
          {network === 'mainnet' && (
            <Alert className="bg-amber-500/10 border-amber-500/30">
              ...
              <AlertDescription className="text-amber-300">
                <strong>Mainnet Deployment:</strong> Ensure you have thoroughly tested on testnet. Real BNB will be used for network costs.
              </AlertDescription>
            </Alert>
          )}
