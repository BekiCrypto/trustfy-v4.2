      ...
      <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700/50 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs">Legacy/compatibility settings (on-chain config applies to new Ads/trades)</p>
          </div>
        ...
        <Alert className="bg-amber-500/10 border-amber-500/30 mb-6">
          ...
          <AlertDescription className="text-amber-300 text-xs">
            <strong>⚠️ Critical:</strong> On-chain changes affect new Ads and trades only. Verify parameters carefully before submitting blockchain transactions.
          </AlertDescription>
        </Alert>
        ...
        <div className="pt-6 border-t border-slate-700/50 space-y-4">
          ...
          <Alert className="bg-blue-500/10 border-blue-500/30">
            ...
            <AlertDescription className="text-blue-300 text-xs">
              ...
              Prevents frequent small withdrawals that waste network costs.
            </AlertDescription>
          </Alert>
