  ...
  const errorGuides = {
    ...
    wallet: {
      ...
      solutions: [
        ...
        'Check if you have enough tokens for network costs',
    ...
    balance: {
      ...
      solutions: [
        ...
        'Ensure you have enough for the amount and bond',
        'View required amounts in the bond breakdown section'
      ]
    },
    gas: {
      icon: AlertTriangle,
      title: 'Network Cost Error',
      description: 'Network cost estimation failed',
      solutions: [
        'Make sure you have enough BNB for network costs',
        'Retry the transaction from your wallet',
    ...
    timeout: {
      ...
      solutions: [
        ...
        'Retry after a few minutes if the network is busy',
