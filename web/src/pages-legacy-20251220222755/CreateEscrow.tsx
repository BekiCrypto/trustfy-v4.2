  ...
  return (
    <section className="space-y-6">
      <header className="space-y-3">
        ...
        <h1 className="section-title text-[color:var(--ink)]">Seller flow</h1>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {templates.map((template) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-[color:var(--ink)]">{template.description}</p>
      ...
      {activeTab === "manual" && (
        ...
        >
          ...
          <div className="rounded-2xl border border-[color:var(--line)] bg-slate-900/60 p-4 text-xs text-[color:var(--muted)]">
