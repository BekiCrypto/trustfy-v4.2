...
const ArbitratorDisputeDetailPage = () => {
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <div className="space-y-4 lg:col-span-2">
              <article className="card p-5">
                ...
                <p className="text-lg font-semibold text-[color:var(--ink)]">{dispute.status}</p>
                  ...
                  {!loadingEvidence &&
                    (evidence?.length ? (
                      evidence.map((item) => (
                        <article
                          key={item.id}
                          className="flex items-center justify-between rounded-2xl border border-[color:var(--line)] bg-slate-900/60 px-3 py-2 text-xs text-[color:var(--muted)]"
                        >
...
export default ArbitratorDisputeDetailPage
