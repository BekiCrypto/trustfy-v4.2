  ...
  const documentCategories = [
    {
      ...
      docs: [
        { id: 'terms', name: 'Terms and Conditions', description: 'Complete terms of service', icon: FileText, modal: 'terms' },
        { id: 'privacy', name: 'Privacy Policy', description: 'Data protection and privacy', icon: Lock, modal: 'privacy' },
        { id: 'kyc', name: 'Identity & Privacy Policy', description: 'Hybrid auth and optional KYC', icon: Shield, modal: 'kyc' },
        { id: 'disclaimer', name: 'Legal Disclaimer', description: 'Risk notices and limitations', icon: AlertTriangle, modal: 'disclaimer' },
        { id: 'compliance', name: 'Compliance Neutrality Statement', description: 'Regulatory approach', icon: Scale, modal: 'compliance' },
      ]
    },
    {
      ...
      docs: [
        { id: 'docs', name: 'Platform Documentation', description: 'Complete feature overview', icon: BookOpen, modal: 'docs' },
        { id: 'beginner', name: 'Beginner Guide', description: 'Getting started with Trustfy', icon: GraduationCap, modal: 'beginner' },
        { id: 'summary', name: 'Quick Start Guide', description: 'Platform overview in 5 minutes', icon: FileText, modal: 'summary' },
      ]
    },
    {
      ...
      docs: [
        { id: 'safety', name: 'User Safety Guidelines', description: 'Best practices for safe trading', icon: Shield, external: '/Safety' },
        { id: 'anti-fraud', name: 'Anti-Fraud Awareness', description: 'Scam prevention tips', icon: AlertTriangle, modal: 'docs' },
        { id: 'risk', name: 'Risk Disclosure Notice', description: 'Trading risks and warnings', icon: AlertTriangle, modal: 'disclaimer' },
      ]
    }
  ];
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Legal documents, guides, and platform information</p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            {filteredCategories.map((category, idx) => (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <Badge className="ml-2">{category.docs.length} {category.docs.length === 1 ? 'doc' : 'docs'}</Badge>
                </div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-800/50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <h4 className="text-white font-semibold mb-3">Platform Status</h4>
                <p className="text-sm text-slate-400 mb-2">
