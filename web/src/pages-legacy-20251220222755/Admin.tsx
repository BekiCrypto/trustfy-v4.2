  ...
  return (
    <section className="space-y-6">
      <header className="space-y-3">
        ...
        <h1 className="section-title text-[color:var(--ink)]">Admin console</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <article className="stat-card hover-lift">
          ...
          <p className="text-3xl font-semibold text-[color:var(--ink)]">{total}</p>
        </article>
        <article className="stat-card hover-lift">
          <p className="eyebrow">Resolved</p>
          <p className="text-3xl font-semibold text-[color:var(--ink)]">{resolved}</p>
        </article>
        <article className="stat-card hover-lift">
          <p className="eyebrow">Disputed</p>
          <p className="text-3xl font-semibold text-[color:var(--ink)]">{disputed}</p>
        </article>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        >
          ...
          <p className="text-2xl font-semibold text-[color:var(--ink)]">Withdraw fees & bonds</p>
        ...
        >
          ...
          <p className="text-2xl font-semibold text-[color:var(--ink)]">Admins · Arbitrators</p>
          <p className="mt-2 text-xs text-[color:var(--muted)]">
        ...
        >
          ...
          <p className="text-2xl font-semibold text-[color:var(--ink)]">TokenKey metadata</p>
          <p className="mt-2 text-xs text-[color:var(--muted)]">
