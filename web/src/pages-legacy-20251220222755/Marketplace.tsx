    ...
    <section className="space-y-6">
      <header className="space-y-4">
        <div>
          ...
          <h1 className="section-title text-[color:var(--ink)]">Escrows across BSC</h1>
        ...
        <div className="grid gap-3 md:grid-cols-[2fr,1fr]">
          ...
          />
          <div className="flex flex-wrap items-center gap-2 rounded-full border border-[color:var(--line)] bg-slate-900/60 px-2 py-2">
            {isConnected ? (
              <>
                <button
