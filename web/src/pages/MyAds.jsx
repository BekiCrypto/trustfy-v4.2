      ...
      <div className="relative max-w-7xl mx-auto space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-slate-400 mt-1">{t('myAds.subtitle')}</p>
          </div>
          <Button 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            <p className="text-slate-400 text-sm mb-1">{t('myAds.totalListings')}</p>
          ...
          >
            <p className="text-emerald-400 text-sm mb-1">{t('myAds.activeListings')}</p>
          ...
          >
            <p className="text-blue-400 text-sm mb-1">{t('myAds.matchedListings')}</p>
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-xl p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm text-slate-400 mb-1">{t('myAds.trustSignals')}</p>
                <p className="text-lg font-bold text-emerald-400">
                  {t('myAds.tierLabel')} {myProfile.reputation_tier || t('myAds.tierDefault')}
                </p>
              </div>
              <div className="text-right">
