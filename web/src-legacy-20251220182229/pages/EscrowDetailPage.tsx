            ...
            {activeTab === "payment" && (
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-2xl border border-[color:var(--line)] bg-white/70 p-4">
                  ...
                  {isBuyer && (
                    <div className="mt-4 rounded-2xl border border-[color:var(--line)] bg-white px-3 py-2 text-xs text-[color:var(--muted)]">
                  ...
                  <div className="mt-4 space-y-3 text-sm text-[color:var(--muted)]">
                    {fiatHistory.length === 0 ? (
                      ...
                      fiatHistory.map((entry) => (
                        ...
                        >
                          <p className="text-xs font-semibold text-slate-950">{entry.status}</p>
