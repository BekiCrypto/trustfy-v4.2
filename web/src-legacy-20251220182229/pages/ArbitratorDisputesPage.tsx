...
export const ArbitratorDisputesPage = () => {
  ...
  return (
    <section className="space-y-6">
      <header className="space-y-3">
        ...
        <h1 className="section-title text-slate-950">Arbitrator queue</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <article className="stat-card hover-lift">
          ...
          <p className="text-3xl font-semibold text-slate-950">{data?.length ?? 0}</p>
        </article>
        <article className="stat-card hover-lift">
          <p className="eyebrow">Open</p>
          <p className="text-3xl font-semibold text-slate-950">{openDisputes.length}</p>
        </article>
        <article className="stat-card hover-lift">
          <p className="eyebrow">Resolved</p>
          <p className="text-3xl font-semibold text-slate-950">{resolvedDisputes.length}</p>
        </article>
      </div>
